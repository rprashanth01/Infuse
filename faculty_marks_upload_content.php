	...
	<div class="panel panel-default">
		...
		<div id="faculty" class="panel-collapse collapse in">
			<div class="panel-body">
				<form class="form-horizontal" role="form" method="post" action="faculty_marks_upload_table.php">
...
?>
					...
					<div class="form-group">
						<label for="Internal_list" class="col-sm-2 control-label">Choose Category</label>
						<div class="col-sm-2">
							<select class="form-control" name="internal" required>
								...
								<option value="others">other component</option>
