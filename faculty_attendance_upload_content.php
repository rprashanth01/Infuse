	...
	<div class="panel panel-default">
		...
		<div id="faculty" class="panel-collapse collapse in">
			<div class="panel-body">
				<form class="form-horizontal" role="form" method="post" action="faculty_attendance_upload_table.php">
...
?>
					...
					<div class="form-group">
						<label for="c_pass" class="col-sm-2 control-label">Total Classes</label>
						<div class="col-sm-3">
							<input type="text" placeholder="Enter Total Classes Taken" class="form-control" name="fac_tot_class"  required />
						</div>
