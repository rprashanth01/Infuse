...
<div class="panel-group" id="successful_subject_add_panel">
	
	<div class="panel panel-default">
		
		<div class="panel-heading">
			<h4 class="panel-title">
				<a data-toggle="collapse" data-parent="#successful_subject_add_panel" href="#successful_subject_add">Subject Successfully Added</a>
			</h4>
		</div>
		
		<div id="successful_subject_add" class="panel-collapse collapse in">
			<div class="panel-body">
				<p>Subject <?php echo $subject_desc; ?>(<?php echo $subject_id; ?>) was successfully Added!</p>
			</div>
		</div>
